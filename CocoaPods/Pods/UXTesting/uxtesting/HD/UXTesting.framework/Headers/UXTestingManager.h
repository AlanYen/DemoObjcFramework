...
@property (nonatomic,strong) UIWindow* testingWindw;
...
/*!
 * @discussion Pause recording, call resume to start again.
 */
-(void)pause;

/*!
 * @discussion Resume recording after pause.
 */
-(void)resume;
...
@property (nonatomic,readwrite) BOOL isTrackTouchPoint;
